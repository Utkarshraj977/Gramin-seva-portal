...
const travellingAdminReg = asyncHandler(async (req, res) => {
    ...
    const createdTraveller = await TravellingAdmin.create({
        userInfo: user._id,
        carNumber,
        category,
        TravellingAdminKey,
...
const travellerAdminLogin = asyncHandler(async (req, res) => {
    ...
    const istravellervalid = await TravellingAdmin.isTravellerKeyCorrect(TravellingAdminKey)
...
//filter By Category
const getalltravellorbycategory=asyncHandler(async(req,res)=>{
     
})

//filter By Type
const getalltravellorbytype=asyncHandler(async(req,res)=>{
